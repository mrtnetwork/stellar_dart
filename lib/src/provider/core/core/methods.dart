class StellarHorizonMethods {
  ...
  static const StellarHorizonMethods health = StellarHorizonMethods._(
    name: 'health',
    url: '/health',
  );
  ...
  static const StellarHorizonMethods submitTransactionAsynchronously =
      StellarHorizonMethods._(
        name: 'submitTransactionAsynchronously',
        url: '/transactions_async',
      );

  static const StellarHorizonMethods accounts = StellarHorizonMethods._(
    name: 'accounts',
    url: '/accounts',
  );
  static const StellarHorizonMethods account = StellarHorizonMethods._(
    name: 'account',
  ...
  static const StellarHorizonMethods accountEffects = StellarHorizonMethods._(
    name: 'accountEffects',
    url: '/accounts/:account_id/effects',
  );
  static const StellarHorizonMethods accountOffers = StellarHorizonMethods._(
    name: 'accountPayments',
    url: '/accounts/:account_id/offers',
  );
  static const StellarHorizonMethods accountTrads = StellarHorizonMethods._(
    name: 'accountPayments',
    url: '/accounts/:account_id/trades',
  );
  static const StellarHorizonMethods accountData = StellarHorizonMethods._(
    name: 'accountPayments',
    url: '/accounts/:account_id/data/:key',
  );

  static const StellarHorizonMethods ledger = StellarHorizonMethods._(
    name: 'ledger',
    url: '/ledgers/:sequence',
  );
  static const StellarHorizonMethods ledgerTransactions =
      StellarHorizonMethods._(
        name: 'ledgerTransactions',
        url: '/ledgers/:sequence/transactions',
      );
  static const StellarHorizonMethods ledgerPayments = StellarHorizonMethods._(
    name: 'ledgerPayments',
    url: '/ledgers/:sequence/payments',
  );
  static const StellarHorizonMethods ledgerOperations = StellarHorizonMethods._(
    name: 'ledgerOperations',
    url: '/ledgers/:sequence/operations',
  );
  static const StellarHorizonMethods ledgerEffects = StellarHorizonMethods._(
    name: 'ledgerEffects',
    url: '/ledgers/:sequence/effects',
  );

  static const StellarHorizonMethods ledgers = StellarHorizonMethods._(
    name: 'ledgers',
    url: '/ledgers',
  );

  static const StellarHorizonMethods operations = StellarHorizonMethods._(
    name: 'operations',
    url: '/operations',
  );

  static const StellarHorizonMethods operation = StellarHorizonMethods._(
    name: 'operation',
    url: '/operations/:id',
  );
  static const StellarHorizonMethods operationEffects = StellarHorizonMethods._(
    name: 'operationEffects',
    url: '/operations/:id/effects',
  );

  static const StellarHorizonMethods effects = StellarHorizonMethods._(
    name: 'effects',
    url: '/effects',
  );

  static const StellarHorizonMethods offers = StellarHorizonMethods._(
    name: 'offers',
    url: '/offers',
  );
  static const StellarHorizonMethods offer = StellarHorizonMethods._(
    name: 'offer',
    url: '/offers/:offer_id',
  );
  static const StellarHorizonMethods offerTrades = StellarHorizonMethods._(
    name: 'offerTrades',
    url: '/offers/:offer_id/trades',
  );

  static const StellarHorizonMethods tradeAggregations =
      StellarHorizonMethods._(
        name: 'tradeAggregations',
        url: '/trade_aggregations',
      );

  static const StellarHorizonMethods feeStats = StellarHorizonMethods._(
    name: 'feeStats',
    url: '/fee_stats',
  );

  static const StellarHorizonMethods orderBook = StellarHorizonMethods._(
    name: 'orderBook',
    url: '/order_book',
  );

  static const StellarHorizonMethods assets = StellarHorizonMethods._(
    name: 'assets',
    url: '/assets',
  );
  ...
  static const StellarHorizonMethods liquidityPools = StellarHorizonMethods._(
    name: 'liquidityPools',
    url: '/liquidity_pools',
  );
  static const StellarHorizonMethods liquidityPool = StellarHorizonMethods._(
    name: 'liquidityPool',
    url: '/liquidity_pools/:liquidity_pool_id',
  );
  ...
  static const StellarHorizonMethods payments = StellarHorizonMethods._(
    name: 'payments',
    url: '/payments',
  );
  static const StellarHorizonMethods transactionPayments =
      StellarHorizonMethods._(
        ...
        url: '/transactions/:tx_id/payments',
      );

  static const StellarHorizonMethods trades = StellarHorizonMethods._(
    name: 'trades',
    url: '/trades',
  );
  static const StellarHorizonMethods paymentPaths = StellarHorizonMethods._(
    name: 'paymentPaths',
    url: '/paths/strict-receive',
  );
  static const StellarHorizonMethods sendPaymentPaths = StellarHorizonMethods._(
    name: 'sendPaymentPaths',
    url: '/paths/strict-send',
  );
